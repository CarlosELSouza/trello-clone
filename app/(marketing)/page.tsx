...
const MarketingPage = () => {
    ...
    <div className="flex items-center justify-center flex-col">
        ...
        {/* Aqui ele usa o cn para dar um append no modulo de fonte, o primeiro parametro dele são as classes padrões do tw, o segundo são os estilos que queremos incorporar */}
